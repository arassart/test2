<%@ Page Title="S'inscrire" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Register.aspx.vb" Inherits="test24.Register" %>

<%@ Import Namespace="test24" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="UserNameCtrl" CssClass="col-md-2 control-label">Nom d'utilisateur </asp:Label>
            <div class="col-md-10">
